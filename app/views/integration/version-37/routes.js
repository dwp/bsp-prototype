...
router.post('/start-a-new-claim/:scenario', (req, res) => {
  const scenario = req.params.scenario || '1'
  if(req.body.CommunicationNeeds === 'No') {
...
router.post('/verify/:page/:scenario', (req, res) => {
  const scenario = req.params.scenario || '1'
 // addToLog(req, 'verify')
  console.info('scenario.....xxxx', req.body)

  if(req.body['marriage'] != undefined && req.body.marriage['form'] == 'Yes2') {
    res.redirect(`/${req.feature}/${req.sprint}/decisions/are-you-sure/${scenario}`)
  } else if((req.body['marriage'] != undefined && req.body.marriage['verified'] == 'Yes' && (req.body.c1 == 'Yes' || req.body.c2 == 'Yes')) || (req.body['marriage'] != undefined && req.body.marriage['verified1'] == 'Yes' && (req.body.c1 == 'Yes' || req.body.c2 == 'Yes'))) {
    res.redirect(`/${req.feature}/${req.sprint}/task-list/${scenario}`)
  } else if(req.body['marriage'] != undefined && req.body.marriage['form'] == 'Yes' && req.body.marriage.verified == 'No') {
    res.redirect(`/${req.feature}/${req.sprint}/capture/evidence-needed/${scenario}`)
  } else if(req.body['marriage'] != undefined && req.body.marriage['form'] == 'Yes1' && req.body.marriage.verified1 == 'No') {
    res.redirect(`/${req.feature}/${req.sprint}/capture/c-evidence-needed/${scenario}`)
  } else if((req.body['marriage'] != undefined && req.body.chb !=undefined && req.body.chb['answer'] == 'Yes') || (req.body['marriage'] != undefined && req.body.chb !=undefined && req.body.chb['answer'] == 'No') || (req.body['marriage'] != undefined && req.body.chb !=undefined && req.body.chb['answer'] == '')) {
    res.redirect(`/${req.feature}/${req.sprint}/task-list/${scenario}`)
  } else if(req.body['marriage'] !=undefined && req.body.marriage['verified1'] == 'Yes' && req.body.c1 == 'No' && req.body.c2 == 'No' && req.body.marriage['form'] == 'Yes1'){
    res.redirect(`/${req.feature}/${req.sprint}/decisions/ch-are-you-sure/${scenario}`)
  } else if(((req.body['marriage'] != undefined && req.body.marriage['verified'] == 'Yes' && (req.body.c1 == 'No' || req.body.c2 == 'No')))){
    res.redirect(`/${req.feature}/${req.sprint}/task-list/${scenario}`)
  } else{
    res.redirect(`/${req.feature}/${req.sprint}/task-list/${scenario}`)
  }
...
router.post('/capture/:page/:scenario', (req, res) => {
  ...
  if(req.body.m1 == 'No') {
    ...
    if(req.body.cd1 == 'Yes' && req.body.children['pregnant'] == 'No' && req.body.children['dependant-children'] == 'No') {
      res.redirect(`/${req.feature}/${req.sprint}/decisions/ch-are-you-sure/${scenario}`)
    } else {
      res.redirect(`/${req.feature}/${req.sprint}/task-list/${scenario}`)
    }
  } else if(req.body.disallowthecliam == 'Yes1'){
    res.redirect(`/${req.feature}/${req.sprint}/decisions/c-are-you-sure/${scenario}`)
  } else if(req.body.disallowthecliam == 'Yes3') {
...
router.get('/decisions/ch-disallowed/:scenario', (req, res) => {
  const scenario = req.params.scenario
  const d = require(`./_dummy-data/${scenario}.json`)
  res.render(`${req.feature}/${req.sprint}/decisions/ch-disallowed`, {scenario, d})
})
